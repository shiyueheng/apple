// JavaScript Document//==================================================== 参数设定部分 =======================================================
var bMoveable=true;    //设置日历是否可以拖动
var _VersionInfo="关闭选择"  //版本信息Version:2.0
...
//strFrame+='<td width=48 qy2007
strFrame+='<td width=118 align=center style="font-size:12px;cursor:default" Author=meizz  ';
